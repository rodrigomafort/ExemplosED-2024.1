...
Assim como nas listas não ordenadas, cada item dessa lista é um objeto da classe Elemento.
...
class ListaSO
{
    public:
        ...
        ~ListaSO(); //Destrutor - libera a memória utilizada na lista
        ...
        int BuscaOrdenada(int ID) const; //Busca ordenada pelo primeiro elemento que apresenta esse ID. Se não for localizado, retorna a posição onde o elemento deve ser inserido.
        int BuscaBinaria(int ID) const; //Busca binária pelo primeiro elemento que apresenta esse ID. Se não for localizado, retorna a posição onde o elemento deve ser inserido
